...
function play3(){
    ...
    setTimeout(moveBlock4, 700);
    setTimeout(moveBlock3, 1100);
    setTimeout(moveBlock4Copy, 1300);
    setTimeout(moveBlock1, 1500);
    setTimeout(moveBlock2, 1800);
    setTimeout(moveBlock4, 2100);
    setTimeout(moveBlock2Copy, 2500);
    setTimeout(moveBlock3, 2600);
    
    setTimeout(moveBlock1, 3100);
    setTimeout(moveBlock2Copy2, 3600);
    
    setTimeout(moveBlock3Copy, 3900);
    setTimeout(moveBlock4Copy, 4150);
    setTimeout(moveBlock2, 4400);
    setTimeout(moveBlock3Copy2, 4650);
    setTimeout(moveBlock1Copy, 4900);
    
    setTimeout(moveBlock4, 5300);
    setTimeout(moveBlock2Copy, 5700);
    
    setTimeout(moveBlock1, 6000);
    setTimeout(moveBlock3, 6250);
    setTimeout(moveBlock1Copy, 6500);
    setTimeout(moveBlock3Copy, 6750);
    setTimeout(moveBlock4Copy, 7000);
    
    setTimeout(moveBlock2Copy, 7700);
    setTimeout(moveBlock1Copy2, 7900);
    
    setTimeout(moveBlock4Copy2, 8300);
    setTimeout(moveBlock3Copy2, 8500);
    
    setTimeout(moveBlock2Copy2, 8900);
    setTimeout(moveBlock3, 9100);
    
    setTimeout(moveBlock3Copy, 9500);
    setTimeout(moveBlock4, 9700);
    
    setTimeout(moveBlock4Copy, 10100);
    setTimeout(moveBlock3Copy2, 10300);
    
    setTimeout(moveBlock2, 10500);
    setTimeout(moveBlock3, 10700);
    
    
    setTimeout(moveBlock1, 11000);
    setTimeout(moveBlock2Copy, 11200);
    setTimeout(moveBlock3Copy, 11400);
    setTimeout(moveBlock4Copy2, 11700);
    setTimeout(moveBlock3Copy2, 11900);
    
    setTimeout(moveBlock1Copy, 12200);
    setTimeout(moveBlock2Copy2, 12400);
    
    setTimeout(moveBlock4, 13300);
    setTimeout(moveBlock2, 13500);
    setTimeout(moveBlock3, 14000);
    setTimeout(moveBlock1Copy2, 14100);
    setTimeout(moveBlock2Copy, 14400);
    setTimeout(moveBlock1, 14600);
    
    setTimeout(moveBlock2Copy2, 15500);
    setTimeout(moveBlock3Copy, 15700);
    setTimeout(moveBlock2, 16000);
    setTimeout(moveBlock4, 16200);
    
    setTimeout(moveBlock4Copy, 16700);
    setTimeout(moveBlock3Copy2, 17100);
    setTimeout(moveBlock1, 17200);
    
    setTimeout(moveBlock2, 17600);
    setTimeout(moveBlock4Copy2, 17800);
    setTimeout(moveBlock2Copy, 18100);
    setTimeout(moveBlock1Copy, 18300);
    
    setTimeout(moveBlock3, 18700);
    setTimeout(moveBlock3Copy, 19100);
    setTimeout(moveBlock1Copy2, 19300);
    
    setTimeout(moveBlock3Copy2, 19800);
    setTimeout(moveBlock1, 20000);
    setTimeout(moveBlock3, 20200);
    setTimeout(moveBlock4, 20500);
    
    setTimeout(moveBlock2, 20800);
    setTimeout(moveBlock1Copy, 21000);
    setTimeout(moveBlock3Copy, 21200);
    
    setTimeout(moveBlock2Copy, 21900);
    setTimeout(moveBlock4Copy, 22100);
    setTimeout(moveBlock2Copy2, 22300);
    setTimeout(moveBlock1Copy2, 22500);
    
    setTimeout(moveBlock3Copy2, 22800);
    setTimeout(moveBlock4Copy2, 23000);
    setTimeout(moveBlock2, 23300);
    
    setTimeout(moveBlock1, 24100);
    setTimeout(moveBlock2Copy, 24350);
    setTimeout(moveBlock3, 24600);
    setTimeout(moveBlock4, 24850);
    
    setTimeout(moveBlock2Copy2, 25150);
    setTimeout(moveBlock4Copy, 25550);
    setTimeout(moveBlock1, 25750);
    
    setTimeout(moveBlock3, 26100);
    setTimeout(moveBlock4Copy2, 26450);
    setTimeout(moveBlock3Copy, 26700);
    setTimeout(moveBlock2, 26950);
    setTimeout(moveBlock1Copy, 27200);
    
    setTimeout(moveBlock3Copy2, 27400);
    setTimeout(moveBlock1Copy2, 27800);
    setTimeout(moveBlock4, 28000);
    setTimeout(moveBlock3, 28200);
    setTimeout(moveBlock1, 28400);
    setTimeout(moveBlock2Copy, 28600);
...
function changeTheme(themeName) {
    ...
    case 'theme1':
        ...
        document.querySelector('#game').style.backgroundImage = 'url("media/t1.jpg")';
    ...
    case 'theme2':
        ...
        document.querySelector('#game').style.backgroundImage = 'url("media/t2.avif")';
    ...
    case 'theme3':
        ...
        document.querySelector('#game').style.backgroundImage = 'url("media/t3.jpg")';
    ...
    case 'theme4':
        ...
        document.querySelector('#game').style.backgroundImage = 'url("media/t4.jpg")';
    ...
    case 'theme5':
        ...
        document.querySelector('#game').style.backgroundImage = 'url("media/t5.jpg")';
