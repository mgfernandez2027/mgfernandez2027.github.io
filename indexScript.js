...
function play1(){
    ...
    setTimeout(moveBlock2, 1300);
    setTimeout(moveBlock3, 1800);
    setTimeout(moveBlock4, 2300);
...
document.addEventListener('keydown', event => {
    ...
    if(event.key === "Enter"){
        play1();
    } else if(blockTop1 >= 450 && blockTop1 <= 800 && event.key === 's'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit1=true;
        
    } else if(blockTop2 >= 450 && blockTop2 <= 800 && event.key === 'f'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit2=true;
    } else if(blockTop3 >= 450 && blockTop3 <= 800 && event.key === 'h'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit3=true;
    } else if(blockTop4 >= 450 && blockTop4 <= 800 && event.key === 'k'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit4=true;
    } else if(blockTop1copy >= 450 && blockTop1copy <= 800 && event.key === 's'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit1c=true
    } else if(blockTop2copy >= 450 && blockTop2copy <= 800 && event.key === 'f'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit2c=true;
    } else if(blockTop3copy >= 450 && blockTop3copy <= 800 && event.key === 'h'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit3c=true;
    } else if(blockTop4copy >= 450 && blockTop4copy <= 800 && event.key === 'k'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit4c=true;
    } else if(blockTop1copy2 >= 450 && blockTop1copy2 <= 800 && event.key === 's'){
        counter++;
        counterequate = counter;
        hit1cc=true
        document.getElementById('count').innerHTML = "Count: " + counterequate;
    } else if(blockTop2copy2 >= 450 && blockTop2copy2 <= 800 && event.key === 'f'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit2cc=true;
    } else if(blockTop3copy2 >= 450 && blockTop3copy2 <= 800 && event.key === 'h'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit3cc=true;
    } else if(blockTop4copy2 >= 450 && blockTop4copy2 <= 800 && event.key === 'k'){
        counter++;
        counterequate = counter;
        document.getElementById('count').innerHTML = "Count: " + counterequate;
        hit4cc=true;
